...
func newExternalNetworks(c *NetworkV1Client, namespace string) *externalNetworks {
...
func (c *externalNetworks) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ExternalNetwork, err error) {
	result = &v1.ExternalNetwork{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *externalNetworks) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ExternalNetworkList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ExternalNetworkList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("externalnetworks").
...
func (c *externalNetworks) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *externalNetworks) Create(ctx context.Context, externalNetwork *v1.ExternalNetwork, opts metav1.CreateOptions) (result *v1.ExternalNetwork, err error) {
	result = &v1.ExternalNetwork{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("externalnetworks").
...
func (c *externalNetworks) Update(ctx context.Context, externalNetwork *v1.ExternalNetwork, opts metav1.UpdateOptions) (result *v1.ExternalNetwork, err error) {
	result = &v1.ExternalNetwork{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("externalnetworks").
...
func (c *externalNetworks) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *externalNetworks) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *externalNetworks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ExternalNetwork, err error) {
	result = &v1.ExternalNetwork{}
