...
// PUTrafficActionsGetter has a method to return a PUTrafficActionInterface.
...
// pUTrafficActions implements PUTrafficActionInterface
type pUTrafficActions struct {
	client rest.Interface
	ns     string
}

// newPUTrafficActions returns a PUTrafficActions
func newPUTrafficActions(c *NetworkV1Client, namespace string) *pUTrafficActions {
	return &pUTrafficActions{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *pUTrafficActions) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.PUTrafficAction, err error) {
	result = &v1.PUTrafficAction{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("putrafficactions").
		Name(name).
...
func (c *pUTrafficActions) List(ctx context.Context, opts metav1.ListOptions) (result *v1.PUTrafficActionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.PUTrafficActionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("putrafficactions").
...
func (c *pUTrafficActions) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *pUTrafficActions) Create(ctx context.Context, pUTrafficAction *v1.PUTrafficAction, opts metav1.CreateOptions) (result *v1.PUTrafficAction, err error) {
	result = &v1.PUTrafficAction{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("putrafficactions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(pUTrafficAction).
		Do(ctx).
		Into(result)
	return
}
...
func (c *pUTrafficActions) Update(ctx context.Context, pUTrafficAction *v1.PUTrafficAction, opts metav1.UpdateOptions) (result *v1.PUTrafficAction, err error) {
	result = &v1.PUTrafficAction{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("putrafficactions").
		Name(pUTrafficAction.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(pUTrafficAction).
		Do(ctx).
		Into(result)
...
func (c *pUTrafficActions) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *pUTrafficActions) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *pUTrafficActions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.PUTrafficAction, err error) {
	result = &v1.PUTrafficAction{}
