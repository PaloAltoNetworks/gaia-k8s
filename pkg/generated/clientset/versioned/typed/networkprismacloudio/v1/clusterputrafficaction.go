...
// ClusterPUTrafficActionsGetter has a method to return a ClusterPUTrafficActionInterface.
...
// clusterPUTrafficActions implements ClusterPUTrafficActionInterface
type clusterPUTrafficActions struct {
	client rest.Interface
}

// newClusterPUTrafficActions returns a ClusterPUTrafficActions
func newClusterPUTrafficActions(c *NetworkV1Client) *clusterPUTrafficActions {
	return &clusterPUTrafficActions{
		client: c.RESTClient(),
	}
}
...
func (c *clusterPUTrafficActions) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.ClusterPUTrafficAction, err error) {
	result = &v1.ClusterPUTrafficAction{}
	err = c.client.Get().
		Resource("clusterputrafficactions").
		Name(name).
...
func (c *clusterPUTrafficActions) List(ctx context.Context, opts metav1.ListOptions) (result *v1.ClusterPUTrafficActionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.ClusterPUTrafficActionList{}
	err = c.client.Get().
		Resource("clusterputrafficactions").
...
func (c *clusterPUTrafficActions) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *clusterPUTrafficActions) Create(ctx context.Context, clusterPUTrafficAction *v1.ClusterPUTrafficAction, opts metav1.CreateOptions) (result *v1.ClusterPUTrafficAction, err error) {
	result = &v1.ClusterPUTrafficAction{}
	err = c.client.Post().
		Resource("clusterputrafficactions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clusterPUTrafficAction).
		Do(ctx).
		Into(result)
	return
}
...
func (c *clusterPUTrafficActions) Update(ctx context.Context, clusterPUTrafficAction *v1.ClusterPUTrafficAction, opts metav1.UpdateOptions) (result *v1.ClusterPUTrafficAction, err error) {
	result = &v1.ClusterPUTrafficAction{}
	err = c.client.Put().
		Resource("clusterputrafficactions").
		Name(clusterPUTrafficAction.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(clusterPUTrafficAction).
		Do(ctx).
		Into(result)
...
func (c *clusterPUTrafficActions) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *clusterPUTrafficActions) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *clusterPUTrafficActions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.ClusterPUTrafficAction, err error) {
	result = &v1.ClusterPUTrafficAction{}
