...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=network.prismacloud.io, Version=v1
	case v1.SchemeGroupVersion.WithResource("clusterenforcers"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Network().V1().ClusterEnforcers().Informer()}, nil
	case v1.SchemeGroupVersion.WithResource("clusterenforcerprofiles"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Network().V1().ClusterEnforcerProfiles().Informer()}, nil
	case v1.SchemeGroupVersion.WithResource("clusterexternalnetworks"):
